namespace AnimeExporterTests.TestUtility {
    ...
    public class TestConstants {
        ...
        public class FMABrotherhood {
            ...
            public const bool HasStreaming = true;
            public const bool IsInEnglish = true;
            public const bool IsInJapanese = true;
            public const bool IsInSpanish = true;
            public const bool IsOnCrunchyRoll = true;
            public const bool IsOnHulu = false;
            public const string Producer = "Cook, Justin";
            public const string PromoVideo = "https://www.youtube.com/embed/1IIgtdFWvBI?enablejsapi=1&wmode=opaque&autoplay=1";
        ...
        public class KimiNiTodoke {
            ...
            public const bool IsOnCrunchyRoll = true;
            public const bool IsOnHulu = true;
            public const string Producer = "Ishikawa, Michiru";
            public const string PromoVideo = "https://www.youtube.com/embed/_gJR6gfRYEQ?enablejsapi=1&wmode=opaque&autoplay=1";
        ...
        public class SteinsGate {
            ...
            public const bool HasStreaming = false;
            public const bool IsOnCrunchyRoll = false;
            public const bool IsOnHulu = false;
            public const string PartialBackground = "Steins;Gate";
            public const string PromoVideo = "https://www.youtube.com/embed/27OZc-ku6is?enablejsapi=1&wmode=opaque&autoplay=1";
